...
To install MPS Motion Tracking, run this command in your terminal:

.. code-block:: console

    $ pip install mps_motion_tracking

This is the preferred method to install MPS Motion Tracking, as it will always install the most recent stable release.
...
The sources for MPS Motion Tracking can be downloaded from the `Github repo`_.

You can either clone the public repository:

.. code-block:: console

    $ git clone git@github.com:finsberg/mps_motion_tracking.git

Or download the `tarball`_:

.. code-block:: console

    $ curl -OJL https://github.com/finsberg/mps_motion_tracking/tarball/master
...
.. _Github repo: https://github.com/finsberg/mps_motion_tracking
.. _tarball: https://github.com/finsberg/mps_motion_tracking/tarball/master
